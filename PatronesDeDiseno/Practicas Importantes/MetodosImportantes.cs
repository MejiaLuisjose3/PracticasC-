using PatronesDeDiseno.Fabrica;
using System;
...
namespace PatronesDeDiseno.Practicas_Importantes
{
    public class MetodosImportantes
    {
        ...
        public static void Fabrica()
        {
            ...
            var fabriC = fabrica.GetConexion("MYSQL");
            fabriC.Conctar();
            fabriC.Desconctar();

            var fabriCA = fabrica.GetConexion("SQLITE");
            fabriCA.Conctar();
            fabriCA.Desconctar();
        }
        ...
        public void metodoUno()
        {
            ...
            byte[] bytes = Encoding.Unicode.GetBytes("llave");
            //Encrypt
            SymmetricAlgorithm crypt = Aes.Create();
            HashAlgorithm hash = MD5.Create();
            crypt.BlockSize = BlockSize;
            crypt.Key = hash.ComputeHash(Encoding.Unicode.GetBytes("Entidad"));
            crypt.IV = IV;
            ...
            using (MemoryStream memoryStream = new MemoryStream())
            {
                ...
                string probando = Convert.ToBase64String(memoryStream.ToArray());
